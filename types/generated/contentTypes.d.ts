...
export interface ApiBookingPropertyBookingProperty
  extends Struct.CollectionTypeSchema {
  collectionName: 'booking_properties';
  info: {
    description: '';
    displayName: 'bookingProperty';
    pluralName: 'booking-properties';
    singularName: 'booking-property';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking-property.booking-property'
    > &
      Schema.Attribute.Private;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imageGroup: Schema.Attribute.Media<'images' | 'files' | 'videos', true>;
    info: Schema.Attribute.JSON &
      ...
      > &
      Schema.Attribute.DefaultTo<'[]'>;
    kitchen: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
    ...
    > &
      Schema.Attribute.Private;
    locationGoogleMap: Schema.Attribute.Text & Schema.Attribute.Required;
    locationName: Schema.Attribute.Text & Schema.Attribute.Required;
    NumPerson: Schema.Attribute.Integer & Schema.Attribute.Required;
    price: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    room: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::booking-property.booking-property': ApiBookingPropertyBookingProperty;
